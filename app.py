...
def load_csv(csvpath):
    with open(csvpath, "r") as csvfile:
        data = [] # Line shows pulling .csv file from folder outside of current folder.
...
def calculate_loan_to_value_ratio(loan_amount, home_value):
    loan_to_value_ratio = int(loan_amount) / int(home_value) # to insure 'loan_amount' and 'home_value' is read as numerical value, use 'int()'
    return loan_to_value_ratio
    # @TODO Implement loan_to_value_ratio calculation


# ⭐️ This function is the main execution point of the application. It triggers all the business logic. ⭐️
def run():
    ...
    # This print statement will display all of the bank data that is provided. - use only to see all bank data.
    ...
    monthly_debt_ratio = int(debt) / int(income)
